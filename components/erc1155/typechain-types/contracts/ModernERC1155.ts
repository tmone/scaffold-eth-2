...
export interface ModernERC1155Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "balanceOfBatch"
...
export interface ModernERC1155 extends BaseContract {
  connect(runner?: ContractRunner | null): ModernERC1155;
  waitForDeployment(): Promise<this>;

  interface: ModernERC1155Interface;
  ...
  setURI: TypedContractMethod<
    [id: BigNumberish, newTokenURI: string],
    [void],
    "nonpayable"
  >;
