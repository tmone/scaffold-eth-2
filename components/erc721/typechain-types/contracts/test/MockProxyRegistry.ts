...
export interface MockProxyRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "owner"
      | "proxies"
...
export interface MockProxyRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): MockProxyRegistry;
  ...
  setProxy: TypedContractMethod<
    [_address: AddressLike, _proxyForAddress: AddressLike],
    [void],
    "nonpayable"
  >;
