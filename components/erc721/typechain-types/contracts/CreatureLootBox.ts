...
export interface CreatureLootBoxInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ERC712_VERSION"
      | "approve"
...
export interface CreatureLootBox extends BaseContract {
  connect(runner?: ContractRunner | null): CreatureLootBox;
  waitForDeployment(): Promise<this>;

  interface: CreatureLootBoxInterface;
  ...
  unpack: TypedContractMethod<[_tokenId: BigNumberish], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "itemsPerLootbox"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
